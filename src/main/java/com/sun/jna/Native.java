...
public final class Native implements Version {
    ...
    public static boolean DEBUG_JNA_LOAD = true;
    ...
    public static List<String> toStringList(final char[] buf, final int offset, final int len) {
        ...
        if (lastPos < maxPos) {
            final String value = new String(buf, lastPos, maxPos - lastPos);
            list.add(value);
        }
    ...
    public static Map getLibraryOptions(final Class type) {
        ...
        synchronized(libraries) {
            if (options.containsKey(mappingClass)) {
                final Map libraryOptions = (Map)options.get(mappingClass);
    ...
    public static String getStringEncoding(final Class cls) {
        final String encoding = (String)getLibraryOptions(cls).get(Library.OPTION_STRING_ENCODING);
    ...
    public static int getStructureAlignment(final Class cls) {
        final Integer alignment = (Integer)getLibraryOptions(cls).get(Library.OPTION_STRUCTURE_ALIGNMENT);
    ...
    */
    ...
    public static String getWebStartLibraryPath(final String libName) {
        ...
        try {
            ...
            final Method m = (Method)AccessController.doPrivileged(new PrivilegedAction() {
                @Override
                public Object run() {
                    try {
                        final Method m = ClassLoader.class.getDeclaredMethod("findLibrary", new Class[] { String.class });
            ...
            final String libpath = (String)m.invoke(cl, new Object[] { libName });
            if (libpath != null) {
    ...
    */
     ...
     */
    public static void setCallbackExceptionHandler(final UncaughtExceptionHandler eh) {
    ...
    */
    ...
    private static void unregisterAll() {
        synchronized(registeredClasses) {
            for (final Iterator i=registeredClasses.entrySet().iterator();i.hasNext();) {
    ...
    private static int getConversion(Class type, final TypeMapper mapper) {
        ...
        if (NativeMapped.class.isAssignableFrom(type)) {
            final Class nativeType = NativeMappedConverter.getInstance(type).nativeType();
            if (nativeType == String.class) {
    ...
    public static void register(final Class cls, final NativeLibrary lib) {
        ...
        for (int i=0;i < handles.length;i++) {
            final Method method = (Method)mlist.get(i);
            String sig = "(";
    ...
    */
     ...
     */
    static Structure invokeStructure(final long fp, final int callFlags, final Object[] args,
                                     final Structure s) {
    ...
    public static void detach(final boolean detach) {
        ...
        if (detach) {
            ...
            final Pointer p = (Pointer)nativeThreadTerminationFlag.get();
